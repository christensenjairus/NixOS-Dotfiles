...
--awful.util.tagnames = {  " ", " ", " ", " ", " ", " ", " ", " ", " ", " "  }
awful.util.tagnames = { " MAIN ", " WWW ", " DEV ", " SYS ", " DOC ", " VIRT ", " CHAT ", " MUS ", " VID ", " GFX " }
...
awful.spawn.with_shell("sleep 3; blueman-applet") -- takes a while, might as well be 4 seconds
awful.spawn.with_shell("sleep 5; kdeconnect-indicator")
awful.spawn.with_shell("sleep 6; nextcloud --background")
awful.spawn.with_shell("sleep 7; flameshot")
awful.spawn.with_shell("sleep 8; bitwarden")
awful.spawn.with_shell("sleep 9; slack")
awful.spawn.with_shell("sleep 10; discord")
awful.spawn.with_shell("sleep 11; teams")
...
awful.spawn.single_instance("pcmanfm", {})
